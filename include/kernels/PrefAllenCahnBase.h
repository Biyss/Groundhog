...
/****************************************************************/
#ifndef PREFALLENCAHNBASE_H
#define PREFALLENCAHNBASE_H
 ...
 */
template<typename T>
class PrefAllenCahnBase : public DerivativeMaterialInterface<JvarMapInterface<KernelValue> >
{
public:
  PrefAllenCahnBase(const InputParameters & parameters);
...
template<typename T>
PrefAllenCahnBase<T>::PrefAllenCahnBase(const InputParameters & parameters) :
...
template<typename T>
InputParameters
PrefAllenCahnBase<T>::validParams()
{
...
template<typename T>
void
PrefAllenCahnBase<T>::initialSetup()
{
...
template<typename T>
Real
PrefAllenCahnBase<T>::precomputeQpResidual()
{
...
template<typename T>
Real
PrefAllenCahnBase<T>::precomputeQpJacobian()
{
...
// template<typename T>
// Real
// PrefAllenCahnBase<T>::computeQpOffDiagJacobian(unsigned int jvar)
// {
