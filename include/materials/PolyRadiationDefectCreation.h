#ifndef POLYRADIATIONDEFECTCREATION_H
#define POLYRADIATIONDEFECTCREATION_H

#include "Material.h"

//Forward Declarations
class PolyRadiationDefectCreation;
 ...
 */
class PolyRadiationDefectCreation : public Material
{
public:
  PolyRadiationDefectCreation(const InputParameters & parameters);
...
#endif //POLYRADIATIONDEFECTCREATION_H
